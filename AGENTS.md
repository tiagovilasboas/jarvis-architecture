...
- Pass brain · workers · ops work as a typed [handoff envelope](docs/cookbook-handoff.md#envelope), not a transcript dump. Start: [week-1](docs/cookbook-handoff.md#week-1). Silent write: [broken handoff](docs/cookbook-handoff.md#broken-handoff).
